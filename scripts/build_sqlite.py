...
def _row(restaurant, is_active: bool = True) -> tuple:
    ...
    return (
        ...
        restaurant.source_updated_at,
        json.dumps(restaurant.source_datasets, ensure_ascii=False),
        restaurant.surveyed_at,
        json.dumps(restaurant.socials, ensure_ascii=False),
        restaurant.district,
